...
/////////////////
const BotName = 'ASRA BOT☄'; 
const instagram = 'https://instagram.com/tasyukur_as'; 
const telegram = 'https://t.me/tasyukur_asra'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/ada ada chanel';
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@tasyukur_as`)
})
